				  ...
				  <div class="form-group col-sm-6">
				    <div class="radio">
					  <label>
					    ...
					    <b>R1</b> Option one is this and that&mdash;be sure to include why it's great
					  </label>
					</div>
				  </div>
				  <div class="form-group col-sm-6">
				    <div class="radio">
					  <label>
					    ...
					    <b>R2</b> Option one is this and that&mdash;be sure to include why it's great
					  </label>
					</div>
				  </div>
				  <div class="form-group col-sm-6">
				    <div class="radio">
					  <label>
					    ...
					    <b>R3</b> Option one is this and that&mdash;be sure to include why it's great
					  </label>
					</div>
				  </div>
				  <div class="form-group col-sm-6">
				    <div class="radio">
					  <label>
					    ...
					    <b>R4</b> Option one is this and that&mdash;be sure to include why it's great
					  </label>
					</div>
				  </div>
				  <div class="form-group">
